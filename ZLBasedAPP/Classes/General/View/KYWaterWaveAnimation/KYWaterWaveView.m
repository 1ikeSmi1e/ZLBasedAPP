...
- (void)wave {
    ...
    if (waveDisplaylink) {// 已经开始过了，则要先去除再添加
        return;
    }
    ...
    boot = [[UIImageView alloc]initWithFrame:CGRectMake(20,12 ,15,15 )];
    boot.tag = 100;
...
- (void)fishJump {
    ...
    self.fish.frame = CGRectMake(waterWaveWidth - pathPadding - 20,waterWaveHeight - 15, 20, 20);
