...
@property (nonatomic, assign) NSInteger grayButtonIndex;
 ...
 *  @param title          提示标题
 *  @param buttonTitles   所有按钮的标题
 *  @param grayButtonIndex 红色按钮的 index
 *  @param redButtonIndex 红色按钮的 index
 *  @param delegate       代理
 *
 *  Tip: 如果没有灰色按钮或者没有红色按钮, grayButtonIndex 给 `-1` redButtonIndex 给'-2' 即可
 */
- (instancetype)initWithTitle:(NSString *)title
                 buttonTitles:(NSArray *)buttonTitles
                redButtonIndex:(NSInteger)redButtonIndex
